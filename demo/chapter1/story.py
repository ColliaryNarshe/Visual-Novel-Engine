...
#-------------------------
# Dialogs:
arjen_dialog = "If the text entered is too large to fit in the box, it will automatically carry over into the next box. Very easy to edit! You can also press enter during gradual typing to show all the text at once. This is revolutionary for text boxes everywhere!"
